...
(function () {
  ...
  function initDocEditor() {
    ...
    var toolKids = [];
    if (rich) toolKids.push(el("div", { class: "seg" }, [editBtn, mdBtn]), sep());
    toolKids.push(tbBold, tbItal, tbStrike, tbLink, sep(),
    ...
    function toggleLinkPop() {
      ...
      pop.hidden = false;
      // The popover is sticky under the toolbar, so it is already in view —
      // a scrolling focus would yank the page to its position in the flow.
