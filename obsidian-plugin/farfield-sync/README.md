...
implementation (verified by a cross-tool test); conflicts write `.remote.md`
siblings; deletions never propagate; bodies with legacy CID-bearing
`ipfs://` refs refuse to push.
