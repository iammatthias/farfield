module github.com/iammatthias/farfield/apps/backup

go 1.25.0

require (
	github.com/iammatthias/farfield/lib/backup v0.0.0
...
replace (
	...
	github.com/iammatthias/farfield/lib/backup => ../../lib/backup
